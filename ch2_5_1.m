% This program is written to simulate the effect of an impulse excitation
% of a spherical object of radius 1 mm using K wave. The photoacoustic wave
% generated from the object is captured by a point sensor (detector) kept
% at a distance of 2 mm from the centre of the object.
...
% defining the excitation pulse type
% by default the excitation is a impulse
